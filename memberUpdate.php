...
<body data-spy="scroll" data-target=".navbar" data-offset="50">
    ...
    <!--Course Section-->
        <div class="col-xl-8 col-lg-6 offwhite">
            <div class="row"><div class="col-12 text-center"><h1>MEMBERS</h1> <hr></div></div>
            <div class="row users hide">
                <div class="col-sm-19 col-6"><h4></i> 1). MEMBER NAME </h4></div>
                ...
                <div class="container-fluid details">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6">Type:- </div>
                    </div>
                </div>
            </div>
        </div>
