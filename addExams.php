                ...
                <div class="row m-0" style="width:100%">
                    ...
                    <div class="col-sm-3 col-6">
                        <div class="row">
                            ...
                            <div class="col-12 mb-md-4">
                                <input type="text" id="cans" name="cans" class="form-control mb-2 mr-sm-2"  placeholder="Correct Answer" style="width:100%; height: 50px;"></br>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-9 col-11">
                        <div class="row">
                            ...
                            <div class="col-12 mb-md-4">
                                <input type="text" id="dis" name="dis" class="form-control mb-2 mr-sm-2"  placeholder="Correct Answer" style="width:100%; height: 50px;"></br>
                            </div>
                        </div>
                    </div>
